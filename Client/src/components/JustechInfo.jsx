export default function JustechInfo() {
    return (
            ...
            <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
                ...
                <div className="relative z-10 text-base max-w-prose mx-auto lg:max-w-5xl lg:mx-0 lg:pr-72">
                    <p className="text-lg text-gray-500">
                        A Tunisian company specializing in the field of technological innovation and in particular
                        digital
                        content,
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
                    <div className="relative z-10">
                        <div className="prose prose-indigo text-gray-500 mx-auto lg:max-w-none">
                            <p>
                                Justech is distinguished not only by solid partners and high-level services but also by
                                a
                                multilingual,
                            ...
                            <p>
                                ...
                                volutpat, diam.
                                Montes, magna cursus nulla feugiat dignissim id lobortis amet. Laoreet sem est phasellus
                                eu proin massa,
                    ...
                    <div className="mt-12 relative text-base max-w-prose mx-auto lg:mt-0 lg:max-w-none">
                        ...
                        <blockquote className="relative bg-white rounded-lg shadow-lg">
                            ...
                            <cite
                                className="relative flex items-center sm:items-start bg-indigo-600 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                <span
                  ...
                  />
                                ...
                                <span
                                    className="relative ml-4 text-indigo-300 font-semibold leading-6 sm:ml-24 sm:pl-1">
