...
export default function Modal({modalState,open, setOpen}) {
                    ...
                    <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel
                                ...
                                <div>
                                    {modalState.error ? <div
                                        className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-700">
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900">
                                            {modalState.error ? 'Update Error' : 'Update Success'}
                                        </Dialog.Title>
                                        <div className="mt-2">
