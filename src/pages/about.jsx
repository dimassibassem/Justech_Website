...
const About = () => {
  return (
    <div className='bg-white'>
      ...
      <main>
        <h1
          className='py-16 mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl'>
          Let&apos;s talk {' '}
        ...
        <h2 className='px-20 pt-10 pb-8 font-medium tracking-tight text-5xl text-[#013888] sm:text-4xl'>
          Justech
        </h2>
        <p
          className='sm:leading-loose md:leading-loose lg:leading-loose tracking-wide px-20 pt-5 pb-2 font-medium text-xl text-black sm:text-2xl md:text-3xl '>
